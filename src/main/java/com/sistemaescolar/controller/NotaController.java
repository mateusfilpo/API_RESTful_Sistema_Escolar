...
import com.sistemaescolar.service.NotaService;
...
public class NotaController {
	...
	@PostMapping
	public ResponseEntity<Nota> insert(@RequestBody NotaDto obj) {
		Nota nota = service.insert(obj);
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(nota.getId()).toUri();
